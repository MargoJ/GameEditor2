...
object FileUtils
{
    ...
    private fun getProgramData(): String
    {
        ...
        {
            return System.getenv("AppData") + File.separator + "MargoJEditor2" + File.separator
        }
        else
        {
            return System.getProperty("user.home") + File.separator + ".MargoJEditor2" + File.separator
        }
    }
}