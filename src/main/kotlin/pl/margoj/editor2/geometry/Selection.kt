...
open class Selection(points: Collection<Point>) : Iterable<Point>
{
    ...
    var points: Collection<Point> = points
        set(points)
        {
            field = points
    ...
    open fun absolutize(): Selection
    {
        return this.relativize(Point(-this.lowestX, -this.lowestY))
    }

    open fun relativize(startPoint: Point): Selection
    {
    ...
    open fun toRawSelection(): Array<Array<Point>>
    {
        return pointsArray!!
    }
    ...
    override fun equals(other: Any?): Boolean
    {
        ...
        return this.points == points1!!.points
    }
